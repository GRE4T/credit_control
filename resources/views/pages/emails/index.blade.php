...
<div class="breadcrumb">
  <ul class="d-flex align-items-center">
    <li>
      <img height="50px" src="{{asset('assets/images/icons/emails.svg')}}" alt="">
    </li>
    <li class="h5 bold"> Correos Electronicos </li>
  </ul>
</div>
<div class="row mb-2">
  <div class="col">
    <a class="btn btn-success" href="{{ route('emails.create')}}">Añadir nuevo</a>
  </div>
</div>
<div class="card mb-4">
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table id="table_emails" class="table table-borderless table-hover">
        <thead>
          <tr>
            <th scope="col">#</th>
  ...
  function deleteEmail(id)
  {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete("{{ url('emails') }}/" + id, null, {
          header: {
