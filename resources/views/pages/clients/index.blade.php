...
<div class="breadcrumb">
  <ul class="d-flex align-items-center">
    <li>
      <img height="50px" src="{{asset('assets/images/icons/clientes.svg')}}" alt="">
    </li>
    <li class="h5 bold"> Clientes </li>
  </ul>
</div>
<div class="row mb-2">
  <div class="col">
    <a class="btn btn-success" href="{{ route('clients.create')}}">Añadir nuevo</a>
  </div>
</div>
<div class="card mb-4">
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table id="table_clients" class="table table-borderless table-hover">
        <thead>
          <tr>
            <th scope="col">#</th>
    ...
    $('#table_clients').DataTable({
      ...
      columns: [{
        ...
        },
        {
          ...
          render(data) {
            return `
                    <a href="{{ url('clients') }}/${data}/edit" class="text-success mr-2">
  ...
  function deleteClient(id) 
  {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete("{{ url('clients') }}/" + id, null, {
          header: {
