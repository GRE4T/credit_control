...
<div class="breadcrumb">
  <ul class="d-flex align-items-center">
    ...
    <li class="h5 bold">Hosting Servidores </li>
  </ul>
</div>
<div class="row mb-2">
  <div class="col">
    <a class="btn btn-success" href="{{ route('servers.create')}}">Añadir nuevo</a>
  </div>
</div>
<div class="card mb-4">
  ...
  <div class="card-body">
    <div class="table-responsive-md">
      <table id="table_servers" class="table table-borderless table-hover">
        <thead>
          <tr>
            <th scope="col">#</th>
    ...
    $('#table_servers').DataTable({
      ...
      columns: [{
        ...
        },
        {
          ...
          render(data) {
            return `
                    <a href="{{ url('servers') }}/${data}/edit" class="text-success mr-2">
  ...
  function deleteServer(id) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete("{{ url('servers') }}/" + id, null, {
            header: {
