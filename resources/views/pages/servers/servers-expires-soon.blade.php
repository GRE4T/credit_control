<div class="table-responsive-md">
  <h4 class="bg-secondary text-center w-100 text-white p-2">Servidores </h4>
  <table id="table_servers_expires_soon" class="table table-borderless table-hover">
    <thead>
      <tr>
        <th scope="col">#</th>
...
<script type="text/javascript">
  ...
  $(document).ready(() => {
    let cont = 0;
    $('#table_servers_expires_soon').DataTable({
      dom: 'Bfrtip',
      buttons: [
        'excel',
        {
