...
<div class="breadcrumb">
  <ul class="d-flex align-items-center">
    <li>
      <img height="50px" src="{{asset('assets/images/icons/certificates.svg')}}" alt="">
    </li>
    <li class="h5 bold"> Certificados </li>
  </ul>
</div>
<div class="row mb-2">
  <div class="col">
    <a class="btn btn-success" href="{{ route('certificates.create')}}">Añadir nuevo</a>
  </div>
</div>
<div class="card mb-4">
  ...
  <div class="card-body">
    <div class=" table-responsive">
      <table id="table_certificates" class="table table-borderless table-hover display" style="max-width:100%">
        <thead>
          <tr>
            <th scope="col">#</th>
...
<script type="text/javascript">
    ...
    $('#table_certificates').DataTable({
      ...
      columns: [{
        ...
        },
        {
          ...
          render(data) {
            return `
            <textarea class="bg-white form-control-plaintext" cols="30" wrap="soft" disabled>${data}</textarea>
            `;
          }
        },
        {
        ...
        },
        {
          ...
          render(data, type){
            ...
            let diff =  (expirationDate.getTime() - now.getTime()) / (1000 * 60 * 60 * 24)
  ...
  function deleteCertificate(id) {
    Swal.fire({
      ...
      axios.delete("{{ url('certificates') }}/"  + id, null, {
        header:{
          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        }
      })
        .then((res) => {
          //$('#table_certificates').ajax.reload();
          Swal.fire(
            '¡Eliminado!',
