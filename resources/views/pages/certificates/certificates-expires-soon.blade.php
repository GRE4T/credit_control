<div class="table-responsive">
  ...
  <table id="table_certificates_expires_soon" class="table table-borderless table-hover">
    <thead>
      <tr>
        <th scope="col">#</th>
...
@once
  ...
  $(document).ready(() => {
    let cont = 0;
    $('#table_certificates_expires_soon').DataTable({
      dom: 'Bfrtip',
      buttons: [
        'excel', 
        {
      ...
      ajax: "{{ url('certificates/expires-soon') }}",
      columns: [{
          data: 'id',
        ...
        },
        {
          ...
          render(data) {
            return `
            <textarea class="form-control form-control-plaintext" cols="30" wrap="soft" disabled>${data}</textarea>
            `;
          }
        },
        {
