...
<div class="breadcrumb">
  <ul class="d-flex align-items-center">
    <li>
      <img height="50px" src="{{asset('assets/images/icons/subscriptions.svg')}}" alt="">
    </li>
    <li class="h5 bold"> Suscripciones </li>
  </ul>
</div>
<div class="row mb-2">
  <div class="col">
    <a class="btn btn-success" href="{{ route('subscriptions.create')}}">Añadir nuevo</a>
  </div>
</div>
<div class="card mb-4">
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table id="table_subscriptions" class="table table-borderless table-hover">
        <thead>
          <tr>
            <th scope="col">#</th>
  ...
  function deleteSubscription(id) 
  {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete("{{ url('subscriptions') }}/" + id, null, {
          header: {
