...
<div class="table-responsive">
  <h4 class="bg-secondary text-center w-100 text-white p-2">Dominios</h4>
  <table id="table_domains_expires_soon" class="table display table-borderless table-hover">
  <thead>
    <tr>
      <th scope="col">#</th>
...
@once
  @push('stack-script')
    <script type="text/javascript">
      ...
      $(document).ready(() => {
    let cont = 0;
    $('#table_domains_expires_soon').DataTable({
      dom: 'Bfrtip',
      buttons: [
        'excel',
        {
