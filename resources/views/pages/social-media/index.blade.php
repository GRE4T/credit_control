...
<div class="breadcrumb">
  <ul class="d-flex align-items-center">
    <li>
      <img height="50px" src="{{asset('assets/images/icons/redes-sociales.svg')}}" alt="">
    </li>
    <li class="h5 bold"> Redes sociales</li>
  </ul>
</div>
<div class="row mb-2">
  <div class="col">
    <a class="btn btn-success" href="{{ route('social-media.create')}}">Añadir nuevo</a>
  </div>
</div>
<div class="card mb-4">
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-borderless table-hover" id="table_social-media">
        <thead>
          <tr>
            <th>#</th>
            <th scope="col">Red social / Plataforma</th>
            <th scope="col">Usuario</th>
            <th scope="col">contraseña</th>
            <th scope="col">Código /Clave de seguridad</th>
    ...
    $('#table_social-media').DataTable({
      ...
      columns: [{
...

        {
          ...
          render(data) {
            return `            
            <a href="{{ url('social-media') }}/${data}/edit" class="text-success mr-2">
                        <i class="nav-icon i-Pen-2 font-weight-bold"></i>
                    </a>
                    <a href="javascript:void(0)" class="text-danger mr-2" onclick="deleteSocialMedia(${data})">
  ...
  function deleteSocialMedia(id) 
  {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete("{{ url('social-media') }}/" + id, null, {
          header: {
