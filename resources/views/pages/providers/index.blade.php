...
<div class="breadcrumb">
  <ul class="d-flex align-items-center">
    <li>
      <img height="50px" src="{{asset('assets/images/icons/proveedores.svg')}}" alt="">
    </li>
    <li class="h5 bold"> Proveedores</li>
  </ul>
</div>
<div class="row mb-2">
  <div class="col">
    <a class="btn btn-success" href="{{ route('providers.create')}}">Añadir nuevo</a>
  </div>
</div>
<div class="card mb-4">
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table id="table_providers" class="table table-borderless table-hover">
        <thead>
          <tr>
            <th scope="col">#</th>
    ...
    $('#table_providers').DataTable({
      ...
      columns: [{
        ...
        },
        {
          ...
          render(data) {
            return `
                    <a href="{{ url('providers') }}/${data}/edit" class="text-success mr-2">
                        <i class="nav-icon i-Pen-2 font-weight-bold"></i>
                    </a>
                    <a href="javascript:void(0)" class="text-danger mr-2" onclick="deleteProvider(${data})">
  ...
  function deleteProvider(id) 
  {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete("{{ url('providers') }}/" + id, null, {
          header: {
