...
@section('main-content')
    ...
    <div class="row mb-2">
        <div class="col text-right">
            <a class="btn btn-success" href="{{ route('headquarters.create')}}">Añadir nueva sede</a>
        </div>
    </div>
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive-md">
                <table id="table_headquarters" class="table table-borderless table-hover">
                    <thead>
                    <tr>
                        <th scope="col">#</th>
            ...
            table = $('#table_headquarters').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render(data) {
                            return `
                    <a href="{{ url('headquarters') }}/${data}/edit" class="text-success mr-2">
        ...
        function deleteServer(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.delete("{{ url('api/headquarters') }}/" + id, null)
                        .then((res) => {
                            Swal.fire(
                                '¡Eliminado!',
