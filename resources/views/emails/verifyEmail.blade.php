                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="width:170px;">
                                                                <img height="auto" src="{{ asset('assets/images/email.png')}}" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="170" />
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                <div style="font-size:15px;line-height:1;text-align:left;color:#000000;">Haz clic en el siguiente botón para verificar tu correo electrónico.</div>
                                            </td>
                                        </tr>
                                        <tr>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                                    <tr>
                                                        <td align="center" role="presentation" style="border:none;border-radius:40px;cursor:auto;mso-padding-alt:10px 25px;background:#146CC9;" valign="middle">
                                                            <a style="display:inline-block;background:#146CC9;color:#ffffff;font-size:12px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:5px;" href="{{ $url }}"> Verificar </a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
